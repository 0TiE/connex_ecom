      ...
      <Row>
        <Col Col lg="3" md="4">
          <Nav className="flex-column p-3" style={{ height: '110vh' }}>
            ...
            <Nav.Link as={Link} to="" className={`navlink ${activeComponent === 'address' ? 'active' : ''}`} 
            onClick={() => handleNavClick('address')}>Address</Nav.Link>
            <Nav.Link as={Link} to="" className={`navlink ${activeComponent === 'payment' ? 'active' : ''}`} 
              onClick={() => handleNavClick('payment')}>Payment</Nav.Link>
            <Nav.Link as={Link} to="" className={`navlink ${activeComponent === 'coupon' ? 'active' : ''}`} 
              onClick={() => handleNavClick('coupon')}>Coupon</Nav.Link>
            <Nav.Link as={Link} to="" className={`navlink ${activeComponent === 'user' ? 'active' : ''}`} 
              onClick={() => handleNavClick('user')}>User</Nav.Link>
            <h5 className="mt-4">My Orders</h5>
            <Nav.Link as={Link} to="" className={`navlink ${activeComponent === 'orders' ? 'active' : ''}`} 
              onClick={() => handleNavClick('orders')}>Orders</Nav.Link>
            <Nav.Link as={Link} to="#" className={`navlink ${activeComponent === 'watchlist' ? 'active' : ''}`} 
              onClick={() => handleNavClick('watchlist')}>Watchlist</Nav.Link>
            <Nav.Link as={Link} to="#" className={`navlink ${activeComponent === 'points' ? 'active' : ''}`} 
